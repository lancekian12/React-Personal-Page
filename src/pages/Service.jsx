    ...
    return (
        <div className="bg-background py-16">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row items-start lg:items-center justify-between mt-10">
                ...
                {/* Right Side Form */}
                <div
                    className={`lg:w-1/2 w-full bg-white p-6 sm:p-8 rounded-lg shadow-md transform ${isVisible ? 'translate-x-0' : 'translate-x-[900px]'} transition-transform duration-1000 ease-out`}
